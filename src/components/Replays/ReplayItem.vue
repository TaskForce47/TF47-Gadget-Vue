<template>
	<div class="grad-replay-item">
		...
		<div class="grad-replay-item__btn" :class="valid ? '' : 'grad-replay-item__btn--error'" @click="select">
...
import { formatDate, formatSeconds, formatTime } from '@/services/utils/dateTime';
